        ...
        switch (name) {
            case "name":
                if (!value) {
                    ...
                    error = "Name must contain more than 3 letters";
                }
                break;
            case "email":
            ...
            case "phoneNumber":
                ...
                else if (!/^[6-9]\d{9}$/.test(value)) error = "Phone number must start with 6-9 and have exactly 10 digits";
                break;
            case "address":
            ...
            >
                ...
                <div className="form-group">
                    ...
                    <input
                        ...
                        required
                    />
                    {errors.password && <span className="error password-error">{errors.password}</span>}
                </div>
                <div className="form-group">
